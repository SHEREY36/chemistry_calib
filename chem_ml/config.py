...
class PriorConfig:
    ...
    # Generic dopant model slot (Si:X / SiGe:X / SiGeC:X)
    lnK_X: tuple[float, float] = (0.0, 10.0)
    beta_HCl_X: tuple[float, float] = (-0.5, 0.5)
    beta_GeH4_X: tuple[float, float] = (0.0, 0.5)
    beta_dopant_X: tuple[float, float] = (1.0, 0.5)
